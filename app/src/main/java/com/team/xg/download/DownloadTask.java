...
import com.team.xg.exception.FileAlreadyExistException;
import com.team.xg.exception.NoMemoryException;
...
public class DownloadTask extends AsyncTask<Void, Integer, Long> {
    ...
    public DownloadTask(Context context, String url, String savePath, String saveName,
                        DownloadTaskListener listener) throws MalformedURLException {
        this(context, url, savePath + saveName, listener);
    }
    ...
    private long download() throws NetworkErrorException, IOException,
         ...
         * check net work
		 */
        if (!DownloadNetworkUtils.isNetworkAvailable(context)) {
